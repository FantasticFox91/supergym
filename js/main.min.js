...
var PLANS__BUTTONS__CONTAINER = document.querySelector('.tab__buttons');
var PLANS__BUTTONS = document.querySelectorAll('.tab__button');
var TABS = document.querySelectorAll('.tab__list');
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  PLANS__BUTTONS__CONTAINER.addEventListener('click', function (e) {
    if (e.target.classList.contains('tab__button')) {
      PLANS__BUTTONS.forEach(function (button) {
...
var setupVideo = function setupVideo(video) {
  ...
  var button = video.querySelector('.video__border');
